...
<?php include('header.php');
    ...
    if($stdate==$tddate){
        ?>
        <h1 style="margin: 100px;background-color:red;text-align:center">Status>>Admin will update your grievance status!!!</h1>
        <h1 style="margin: 100px;background-color:red;text-align:center"> Have a nice day!!</h1>
        <br/><hr/>
        <div align='center'>
