    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="price.php" class="nav-item nav-link active">Register</a>
                <a href="courierMenu.php" class="nav-item nav-link">Feedback<a>
                <a href="trackMenu.php" class="nav-item nav-link">Status</a>
